...
export const OBSERVABILITY: Record<string, Observability> = {
  ...
  syd_airportOpsCopilot: {
    ...
    level: 'full',
    gateway: 'enforced',
    note: 'Foundry agent behind the APIM AI gateway — OpenTelemetry to App Insights, plus enforced token metrics, quotas and Content Safety at the gateway.',
  },
  ...
  syd_groundCrewScheduler: {
    ...
    level: 'full',
    gateway: 'enforced',
    note: 'Foundry / custom-code agent fronted by the APIM AI gateway — gateway-grade token metrics and inline Content Safety.',
  },
  syd_retailConcierge: {
    appInsights: false,
    evaluation: false,
