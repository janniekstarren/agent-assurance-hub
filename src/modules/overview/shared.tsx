...
const useStyles = makeStyles({
  ...
  attnIcon: { width: '34px', height: '34px', borderRadius: tokens.borderRadiusMedium, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  attnMain: { flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: '2px' },
  attnName: { fontSize: '13.5px', fontWeight: 600, lineHeight: 1.25 },
  attnDetail: {
    fontSize: '12px',
